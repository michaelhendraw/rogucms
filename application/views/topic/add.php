    ...
    $(document).ready(function(){
        $("#form").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                  type: 'POST',
                  url: '<?php echo base_url()."subject/".$subject_id."/topic/insert"; ?>',
                  data: post_data,
                  processData: false,
                  contentType: false,
                  success: function(data){
                    if(data != 0) {
                      swal({
                        title: '<h4>Topik Gagal Ditambah!</h4>',
                        text: data,
                      ...
                      swal({
                        title: '<h4>Topik Berhasil Ditambah!</h4>',
                        text: 'Selamat, topik berhasil ditambah.',
