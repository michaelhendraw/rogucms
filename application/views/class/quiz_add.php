<h3 class="page-title">Tambah Latihan UN Kelas</h3>
<div class="row">
    <div class="col-md-12">
                ...
                <?php echo form_open_multipart("#", array('id' => 'form', 'class' => 'form-horizontal')); ?>
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="class_subject_id" name="class_subject_id" type="hidden" value="<?php echo isset($class_subject_id) ? $class_subject_id : ''; ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="open_date" name="open_date" type="text" class="form-control datetimepicker" data-date-format="yyyy-mm-dd hh:ii:ss" value="<?php echo date('Y-m-d H:i:s'); ?>" readonly />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="close_date" name="close_date" type="text" class="form-control datetimepicker" data-date-format="yyyy-mm-dd hh:ii:ss" value="<?php echo date('Y-m-d H:i:s',strtotime('+7 days')); ?>" readonly />
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $("#form").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                  type: 'POST',
                  url: '<?php echo base_url()."classes/".$class_id."/subject/".$subject_id."/quiz/insert"; ?>',
                  data: post_data,
                  processData: false,
                  contentType: false,
                  success: function(data){
                    if(data != 0) {
                      swal({
                        title: '<h4>Latihan UN Kelas Gagal Ditambah!</h4>',
                        text: data,
                      ...
                      swal({
                        title: '<h4>Latihan UN Kelas Berhasil Ditambah!</h4>',
                        text: 'Selamat, latihan UN kelas berhasil ditambah.',
