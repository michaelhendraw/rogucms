                ...
                <?php echo form_open_multipart("#", array('id' => 'form', 'class' => 'form-horizontal')); ?>
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="nisn" name="nisn" type="text" class="form-control" onchange="check_nisn(this.value);" />
                            </div>
                        </div>
                        <div class="form-group">
            ...
            submitHandler: function () {
                ...
                $.ajax({
                  ...
                  success: function(data){
                    if(data != 0) {
                      swal({
                        title: '<h4>Siswa Gagal Ditambah!</h4>',
                        text: data,
                      ...
                      swal({
                        title: '<h4>Siswa Berhasil Ditambah!</h4>',
                        text: 'Selamat, siswa berhasil ditambah.',
