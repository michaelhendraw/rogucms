<h3 class="page-title">Ubah Materi</h3>
<div class="row">
    <div class="col-md-12">
    ...
    $(document).ready(function(){
        $("#form").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                  type: 'POST',
                  url: '<?php echo base_url()."subject/".$subject_id."/topic/".$topic_id."/material/update/".$data['id']; ?>',
                  data: post_data,
                  processData: false,
                  contentType: false,
                  success: function(data){
                    if(data != 0) {
                      swal({
                        title: '<h4>Materi Gagal Diedit!</h4>',
                        text: data,
                      ...
                      swal({
                        title: '<h4>Materi Berhasil Diedit!</h4>',
                        text: 'Selamat, materi berhasil diedit.',
